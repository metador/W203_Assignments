...
Since there is a large variation in the values we can basically try to use the log of market value for our analysis.
...
From the boxplot for log of mktval vs grad, we can see that there is greater variation in the market price
```{r}
